...
class PiksiMulti:
    ...
    def cb_sbp_orient_euler(self, msg_raw, **metadata):
    ...
    def cb_sbp_pos_llh(self, msg_raw, **metadata):
        ...
        self.receiver_state_msg.rtk_mode_fix = True if (msg.flags == PosLlhMulti.FIX_MODE_FIX_RTK or msg.flags == 12) else False
